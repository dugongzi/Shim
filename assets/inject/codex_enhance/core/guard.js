// ==Shim==
// @name        Shim codex_enhance — core/guard
// @description 所有分片的入口。once guard + 初始化 window.__shimCodex 命名空间根。
...
(() => {
  ...
  // 命名空间根。各分片往下挂自己的子命名空间, 不要替换整个 __shimCodex 引用。
  // 子命名空间在各自分片里 init, 此处只保证根存在。
  window.__shimCodex = window.__shimCodex || {
    ids: {},
    bridge: null,
    i18n: null,
